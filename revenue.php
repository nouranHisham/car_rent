...
if ($type == 'revenue'){
    ...
    $query = mysqli_query($conn,"SELECT * FROM `rental` as r Left JOIN car as c on c.carid = r.carid left join customer as cu on cu.cid = r.cid
     WHERE rentdate <='$startDate' AND returndate >= '$endDate'" );
...
<div class="container" style="padding: 5%; overflow: auto;">
                                <form action="" method="post" class="row">
                                    <table class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <tr>
                                            ...
                                            <td style="font-size:1.1em;text-align:center;"> Type </td>
                                            <td style="font-size:1.1em;text-align:center;"> Manufacturer </td>
                                            <td style="font-size:1.1em;text-align:center;"> Color </td>
                                            <td style="font-size:1.1em;text-align:center;"> Engine </td>
                                            <td style="font-size:1.1em;text-align:center;"> Plate Number </td>
                                            <td style="font-size:1.1em;text-align:center;"> Rate </td>
                 ...
                 <td style="background-color:White;"><?php echo $row["color"]; ?></td>
                 <td style="background-color:White;"><?php echo $row["capacity"]; ?></td>
                 <td style="background-color:White;"><?php echo $row["plate_number"]; ?></td>
                 <td style="background-color:White;"><?php echo $row["rate"]; ?></td>
